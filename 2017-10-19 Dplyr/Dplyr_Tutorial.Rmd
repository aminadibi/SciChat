...
#### *This tutorial was written by the instructors of STAT 545*  
...
`dplyr`, is a handy R package for manipulating data frames, through six main functions. According to the [R for data science](http://r4ds.had.co.nz/transform.html) book, the main five (in different order) are:
...
Then there's `group_by()`, which can be used in conjunction with all of these, and "piping" brings it all together!
